...
import { Container, Row, Col, Card, CardHeader, CardBody, Media, Form, FormGroup, Label, Input, Button } from "reactstrap";
                ...
                <CardBody>
                  <Row>
                    ...
                    <div className="text-end">
                      <button className="btn btn-primary btn-pill mt-4" type="submit">
                        Update Profile
                      </button>
                    </div>
                  </Row>
