...
const DragAndDrop = (props) => {
  ...
  return (
    <Fragment>
      <Breadcrumb parent="Ui Elements" title="Drag-N-Drop" />
        ...
        <Row>
          <Col sm="12">
            <Card>
              ...
              <CardBody>
                <Row className="ui-sortable small-drag" id="draggableMultiple">
                  <div className="container" ref={dragulaDecorator}>
                    ...
                    <div>
                      There's also the possibility of moving elements around in
                      the same container, changing their position
                    </div>
                    <div>
          ...
          <Col sm="12">
            <Card>
              ...
              <CardBody>
                <Row className="ui-sortable" id="draggableMultiple">
