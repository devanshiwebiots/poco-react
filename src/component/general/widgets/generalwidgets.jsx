                ...
                <Row>
                    ...
                    <div className="browser-widget b-r-light">
                      <div className="media">
                        <div className="media-img">
                          <img src={("/assets/images/dashboard/pc.png")} alt="" />
                        </div>
                  ...
                  <Col md="4" sm="12">
                    <div className="browser-widget b-r-light">
                      <div className="media">
                        <div className="media-img">
                          <img src={("/assets/images/dashboard/tab.png")} alt="" />
                        </div>
                        <div className="media-body align-self-center">
                          <div>
                            <p>Daily </p>
                  ...
                  <Col md="4" sm="12">
                    <div className="browser-widget hover">
                      <div className="media">
                        <div className="media-img">
                          <img src={("/assets/images/dashboard/mobile.png")} alt="" />
                        </div>
                        <div className="media-body align-self-center">
                          <div>
                            <p>Daily </p>
                  ...
                  <Table>
                    ...
                    <tbody>
                      <tr>
                        <td className="bd-t-none u-s-tb">
                          <div className="align-middle image-sm-size">
                            <img className="img-radius m-r-15 rounded-circle" src={("/assets/images/user/4.jpg")} alt="" />
                      ...
                      <tr>
                        <td className="bd-t-none u-s-tb">
                          <div className="align-middle image-sm-size">
                            <img className="img-radius m-r-15 rounded-circle" src={("/assets/images/user/1.jpg")} alt="" />
                            <div className="d-inline-block">
                              <h6>
                      ...
                      <tr>
                        <td className="bd-t-none u-s-tb">
                          <div className="align-middle image-sm-size">
                            <img className="img-radius m-r-15 rounded-circle" src={("/assets/images/user/5.jpg")} alt="" />
                            <div className="d-inline-block">
                              <h6>
                                Mohsib lara
                      ...
                      <tr>
                        <td className="bd-t-none u-s-tb">
                          <div className="align-middle image-sm-size">
                            <img className="img-radius m-r-15 rounded-circle" src={("/assets/images/user/7.jpg")} alt="" />
                            <div className="d-inline-block">
                              <h6>
