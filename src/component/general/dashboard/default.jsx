          ...
          <Col xl="6 xl-100 box-col-12">
            <Card className="weather-bg">
              ...
              <CardBody className="weather-bottom-bg p-0">
                <div className="cloud">
                  <Media src={("/assets/images/cloud.png")} alt="" />
                </div>
                ...
                <Media className="img-fluid" src={("/assets/images/dashboard/weather-image.png")} alt="" />
              </CardBody>
            </Card>
          </Col>
          <Col xl="6 xl-100 box-col-12">
                      ...
                      <tr>
                        <td>
                          <div className="activity-image">
                            <Media className="img-fluid" src={("/assets/images/dashboard/clipboard.png")} alt="" />
                          </div>
                        </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <div className="activity-image activity-secondary">
                            <Media className="img-fluid" src={("/assets/images/dashboard/greeting.png")} alt="" />
                          </div>
                        </td>
                        <td>
                          <div className="activity-details">
                      ...
                      <tr>
                        <td>
                          <div className="recent-images">
                            <Media className="img-fluid" src={("/assets/images/dashboard/recent-user-1.png")} alt="" />
                          </div>
                        </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <div className="recent-images-primary">
                            <Media className="img-fluid" src={("/assets/images/dashboard/recent-user-2.png")} alt="" />
                          </div>
                        </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <div className="recent-images-secondary">
                            <Media className="img-fluid" src={("/assets/images/dashboard/recent-user-3.png")} alt="" />
                          </div>
                        </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <div className="recent-images-warning">
                            <Media className="img-fluid" src={("/assets/images/dashboard/recent-user-4.png")} alt="" />
                          </div>
                        </td>
                        <td>
