                      ...
                      <tr>
                        <td>
                          <div className="recent-images">
                            <img className="img-fluid" src={("/assets/images/dashboard-ecommerce/1.png")} alt="" />
                          </div>
                        </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <div className="recent-images-primary">
                            <img className="img-fluid" src={("/assets/images/dashboard-ecommerce/2.png")} alt="" />
                          </div>
                        </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <div className="recent-images-secondary">
                            <img className="img-fluid" src={("/assets/images/dashboard-ecommerce/3.png")} alt="" />
                          </div>
                        </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <div className="recent-images-warning">
                            <img className="img-fluid" src={("/assets/images/dashboard-ecommerce/4.png")} alt="" />
                          </div>
                        </td>
                        <td>
            ...
            <Card className="gradient-secondary o-hidden monthly-overview">
              ...
              <CardBody className="pt-0">
                ...
                <div className="p-watch">
                  <img className="img-fluid" src={("/assets/images/dashboard-ecommerce/watch.png")} alt="" />
                </div>
              </CardBody>
            </Card>
          </Col>
